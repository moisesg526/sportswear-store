    ...
    <div className="form">
      <div className="inner-form">
        ...
        <div className="form-contents">
          <form action="">
            <input className="form-inputs" type="text" placeholder="Email Address" required />
            <input className="form-inputs" type="text" placeholder="First Name" />
            <input className="form-inputs" type="text" placeholder="Last Name" />
          </form>
